...
const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden border-t backdrop-blur-xl" style={{
      ...
      <div className="container mx-auto px-6 lg:px-16 max-w-7xl py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">HyperScale</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#" className="text-sm transition-colors duration-300 hover:text-white" style={{ color: '#b0b0b0' }}>
                  Features
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="/about" className="text-sm transition-colors duration-300 hover:text-white" style={{ color: '#b0b0b0' }}>
                  About Us
                </a>
              </li>
              <li>
        ...
        <div className="pt-8 border-t" style={{ borderColor: 'rgba(255, 255, 255, 0.1)' }}>
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-6">
              <a href="/privacy" className="text-sm transition-colors duration-300 hover:text-white" style={{ color: '#b0b0b0' }}>
                Privacy Policy
              </a>
              <a href="/terms" className="text-sm transition-colors duration-300 hover:text-white" style={{ color: '#b0b0b0' }}>
                Terms of Service
              </a>
              <a href="#" className="text-sm transition-colors duration-300 hover:text-white" style={{ color: '#b0b0b0' }}>
                Cookie Policy
