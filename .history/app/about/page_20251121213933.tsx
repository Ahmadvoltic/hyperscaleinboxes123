...
export default function About() {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#1c1c1c' }}>
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden" style={{ backgroundColor: '#1c1c1c', minHeight: '600px' }}>
        ...
        <div className="absolute inset-0 backdrop-blur-[2px]" style={{ backgroundColor: 'rgba(10, 10, 10, 0.15)' }}></div>
      ...
      <section className="py-20" style={{ backgroundColor: '#1c1c1c' }} data-section="cards">
        <div className="container mx-auto px-6 lg:px-16 max-w-7xl">
          <div className={`grid md:grid-cols-2 lg:grid-cols-3 gap-8 transition-all duration-1000 ${isVisible.cards ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="relative bg-gradient-to-br from-white/5 to-white/[0.02] backdrop-blur-xl rounded-2xl p-8 border border-white/10 hover:border-orange-500/50 transition-all duration-300 group overflow-hidden">
              <div className="absolute inset-0 bg-orange-500/10 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 blur-xl -z-10"></div>
              <div className="absolute -top-20 -right-20 w-40 h-40 rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-500 blur-3xl" style={{ backgroundColor: '#ff6e40' }}></div>
      ...
      {/* Values */}
      <section className="py-20" style={{ backgroundColor: '#1c1c1c' }} data-section="values">
        <div className="container mx-auto px-6 lg:px-16 max-w-7xl">
      ...
      {/* Timeline */}
      <section className="py-20" style={{ backgroundColor: '#1c1c1c' }} data-section="timeline">
