    ...
    <div className="min-h-screen" style={{ backgroundColor: "#1c1c1c" }}>
      ...
      >
        ...
        <div className="absolute inset-0">
          <FloatingLines
            lineColor="#ff6e40" // Single color instead of gradient array
            lineDistance={10}
            wavePosition={{ x: 5.0, y: 0.0, rotate: 0.2 }}
            animationSpeed={1}
            mixBlendMode="screen"
            targetFPS={30} // 30fps for better performance
            enableLazyRendering={true} // Stop rendering when off-screen
          />
        </div>
